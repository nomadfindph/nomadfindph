...
function Footer() {
    ...
    <p>
      Apartment Hunting Made Easy. <br/>
      <span id="footer-brand">by <img src={require('./images/footer-logo.png')} alt="" srcset=""/></span>
    </p>
    ...
    <table className="soc">
      <tr>
        ...
        <td class="socials">
          <a href="/"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
    ...
    <p id="credits"> ©NomadSixers Inc. 2022. All rights reserved. </p>
